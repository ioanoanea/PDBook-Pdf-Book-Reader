...
import com.ioanoanea.pdbook.viewHolders.InProgressViewHolder;
import com.ioanoanea.pdbook.viewHolders.NoItemsViewHolder;

import java.util.ArrayList;

public class InProgressAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public InProgressAdapter(Context context, ArrayList<BookListItem> list){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == 1){
            ...
            InProgressViewHolder viewHolder = new InProgressViewHolder(view);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int i) {
        ...
        if(holder.getItemViewType() == 2){
            ...
            final InProgressViewHolder viewHolder = (InProgressViewHolder) holder;
            ...
            // set current progress bar width
            PercentCalculator percentCalculator = new PercentCalculator();
            viewHolder.progress.setProgress(percentCalculator.getPercent(progressManager.getProgress(list.get(position).getId()),list.get(position).getNumberOfPages()));
